...
* The original package name 'com.shumisoft.url-shortener-shortening-service' is invalid and this project uses 'com.shumisoft.url_shortener_shortening_service' instead.
